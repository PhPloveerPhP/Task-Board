                    ...
                    <div class="card card-border-primary">
                        ...
                        <div class="card-body p-3">
                            ...
                            <button href="#" data-toggle="modal" data-target="#create_task"
                                class="btn btn-card btn-primary btn-block" name="U">Add new</button>
                ...
                <div class="col-12 col-lg-6 col-xl-3">
                    <div class="card card-border-warning">
                        ...
                        <div class="card-body">
                            ...
                            <button href="#" data-toggle="modal" data-target="#create_task"
                                class="btn btn-card btn-primary btn-block" name="P">Add new</button>
                ...
                <div class="col-12 col-lg-6 col-xl-3">
                    <div class="card card-border-danger">
                        ...
                        <div class="card-body">
                            ...
                            <button href="#" data-toggle="modal" data-target="#create_task"
                                class="btn btn-card btn-primary btn-block" name="H">Add new</button>
                ...
                <div class="col-12 col-lg-6 col-xl-3">
                    <div class="card card-border-success">
                        ...
                        <div class="card-body">
                            ...
                            <button href="#" data-toggle="modal" data-target="#create_task"
                                class="btn btn-card btn-primary btn-block" name="C">Add new</button>
                        </div>
                    </div>
                </div>
